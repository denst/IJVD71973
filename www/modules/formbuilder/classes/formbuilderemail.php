...
class FormBuilderEmail {
	...
	public static function connect($config = NULL)
	{
		...
		{
			// Load SwiftMailer
                        $path = Kohana::find_file('formbuildervendor', 'swift/swift_required');
			require Kohana::find_file('formbuildervendor', 'swift/swift_required');
		}

		// Load default configuration
		($config === NULL) and $config = Kohana::$config->load('formbuilder');
		...
		return FormBuilderEmail::$mail = Swift_Mailer::newInstance($transport);
	}
	...
	public static function send($to, $from, $subject, $message, $html = FALSE)
	{
		...
		(FormBuilderEmail::$mail === NULL) and FormBuilderEmail::connect();
...
//		return FormBuilderEmail::$mail->send($message);
		return false;
	}
