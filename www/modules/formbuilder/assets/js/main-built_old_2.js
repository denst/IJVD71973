...
(function (e, t) {
    ...
    ut.event = {
        ...
        fix: function (e) {
            ...
            var t, n, r = e,
                i = ut.event.fixHooks[e.type] || {}, s = i.props ? this.props.concat(i.props) : this.props;
...
function () {
    ...
    return '<form class=\'form\'>\n  <div class=\'controls\'>\n    <% var compiled =  _.reduce(items, function(str, v, k){ %>\n      <% v["name"] = k; %>\n      <% return str + popoverTemplates[v["type"]](v); %>\n    <% }, "") %>\n    <%= compiled %>\n    <hr/>\n    <button id="save" class=\'btn btn-info\'>Сохранить</button><button id="cancel" class=\'btn btn-danger\'>Отмена</button>\n  </div>\n</form>'
    ...
    return '<!-- Text input-->\n<p class="input-control">\n    <% if (label.length > 0) { %><label class="control-label" for="<%= id %>"><%= label %></label><% } %>\n    <input onfocus="if(this.value==\'<%= placeholder %>\')this.value=\'\';" onblur="if(this.value==\'\')this.value=\'<%= placeholder %>\';" name="<%= id %>" class="<%= inputsize %><% if(required) {%> required <% } %>" value="<%= placeholder %>" id="<%= id %>" type="text" placeholder="<%= placeholder %>">\n    <% if (helptext.length > 0) { %><p class="help-block"><%= helptext %></p><% } %>\n    <div class="input-error" style="display: none"></div>\n</p>'
}), define("text!templates/snippet/button.html", [], function () {
    return '<!-- Button -->\n<div class="control-group">\n  <label class="control-label" for="<%= id %>"><%= label %></label>\n  <div class="controls">\n      <button type="sybmit" id="<%= id %>" name="<%= id %>" class=\'btn <%= buttontype %>\'><%= buttonlabel %></button><b class="necessary">*</b>\n  </div>\n</div>'
}), define("text!templates/snippet/multiplecheckboxes.html", [], function () {
    return '<!-- Multiple Checkboxes -->\n<div class="checkbox-control">\n    <h4><%= label %></h4>\n    <% _.each(checkboxes, function(checkbox, i){ %>\n    <% i++%>\n    <p><label for="<%= i %>">\n      <input name="<%= name %>[]" id="<%= i %>" value="<%= checkbox %>" type="checkbox">\n      <%= checkbox %>\n    </label></p><% }); %>\n</div>'
}), define("text!templates/snippet/multiplecheckboxesinline.html", [], function () {
    return '<!-- Multiple Checkboxes (inline) -->\n<div class="checkbox-control">\n    <h4><%= label %></h4>\n    <% _.each(checkboxes, function(checkbox, i){ %>\n    <% i++%>\n    <label class="control-label-element" for="<%= i %>">\n      <input name="<%= name %>[]" id="<%= i %>" value="<%= checkbox %>" type="checkbox">\n      <%= checkbox %>\n    </label><% }); %>\n</div>\n<div class="clearfix"></div>'
}), define("text!templates/snippet/multipleradios.html", [], function () {
    return '<!-- Multiple Radios -->\n<div class="radio-control">\n    <h4><%= label %></h4>\n    <% _.each(radios, function(radios, i){ %>\n    <% i++%>\n    <p><label for="<%= name+\'-\'+i %>">\n      <input name="<%= name %>" id="<%= name+\'-\'+i %>" value="<%= radios %>" type="radio">\n      <%= radios %>\n    </label></p><% }); %>\n</div>'
}), define("text!templates/snippet/multipleradiosinline.html", [], function () {
    return '<!-- Multiple Checkboxes (inline) -->\n<div class="radio-control">\n    <h4><%= label %></h4>\n    <% _.each(radios, function(radios, i){ %>\n    <% i++%>\n    <label class="control-label-element" for="<%= name+\'-\'+i %>">\n        <input name="<%= name %>" id="<%= name+\'-\'+i %>" value="<%= radios %>" type="radio">\n      <%= radios %>\n    </label><% }); %>\n</div>\n<div class="clearfix"></div>'
}), define("text!templates/snippet/selectbasic.html", [], function () {
    return '<!-- Select Basic -->\n<div class="select-control">\n    <h4><%= label %></h4>\n    <select id="<%= id %>" name="<%= id %>"><% _.each(options, function(option, i) { %>\n        <% i++%>\n        <option value="<%= option %>"><%= option %></option><% }); %>\n    </select>\n</div>\n<div class="clearfix"></div>'
}), define("text!templates/snippet/selectmultiple.html", [], function () {
    return '<!-- Select Multiple -->\n<div class="select-control">\n    <h4><%= label %></h4>\n    <select id="<%= id %>" name="<%= id %>" multiple="multiple"><% _.each(options, function(option, i) { %>\n        <% i++%>\n        <option value="<%= option %>"><%= option %></option><% }); %>\n    </select>\n</div>\n<div class="clearfix"></div>'
}), define("text!templates/snippet/textarea.html", [], function () {
    return '<!-- Comment Textarea -->\n<p class="textarea-control">\n    <% if (label.length > 0) { %><label class="control-label" for="<%= id %>"><%= label %></label><% } %>\n    <textarea id="<%= id %>" onfocus="if(this.value==\'<%= textarea %>\')this.value=\'\';" onblur="if(this.value==\'\')this.value=\'<%= textarea %>\';" name="<%= id %>" rows="10" cols="30" placeholder="<%= textarea %>"><%= textarea %></textarea>\n</p>'
}), define("text!templates/snippet/slider.html", [], function () {
    return '<!-- Slider -->\n<div class="slider-container">\n    <link type="text/css" href="http://axes.tadzhibaev.com/formbuilder/css/lib/jquery-ui-1.8.24.custom.css" rel="stylesheet">\n    <script src="http://axes.tadzhibaev.com/formbuilder/js/lib/jquery-ui.min.js" type="text/javascript"></script>\n    <div id="amount-<%= id %>" style="padding-bottom: 5px;"><h4><%= label %>: <%= values[0]%></h4></div>\n    <div id="<%= id %>" style="width: 300px; margin-bottom: 20px" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><a href="#" class="ui-slider-handle ui-state-default ui-corner-all" style="left: 0%;"></a></div>\n    <input type="hidden" name="<%= id %>_count" value="<%= values[0]%>" id="count-<%= id %>">\n</div>\n<div style="display: none" id="script">\n  $(function() {\n      var valMap = [<% _.each(values, function(value) { %><%= value%>,<% }); %>];\n      $("#<%= id %>").slider({\n          min: 0,\n          max: valMap.length - 1,\n          slide: function(event, ui) {                        \n              $("#amount-<%= id %>").html(\'<h4><%= label %>: \' + valMap[ui.value] + \'</h4>\');\n              $("#count-<%= id %>").val(valMap[ui.value]);\n          }       \n      });\n  });\nend script</div>'
}), define("text!templates/snippet/fioinput.html", [], function () {
    return '<!-- Fio input-->\n<p class="input-control">\n    <% if (label.length > 0) { %><label class="control-label" for="<%= id %>"><%= label %></label><% } %>\n    <input onfocus="if(this.value==\'<%= placeholder %>\')this.value=\'\';" onblur="if(this.value==\'\')this.value=\'<%= placeholder %>\';" name="<%= id %>" class="form-control <%= inputsize %><% if(required) {%> required <% } %>" value="<%= placeholder %>" id="<%= id %>" type="text" placeholder="<%= placeholder %>">\n    <% if (helptext.length > 0) { %><p class="help-block"><%= helptext %></p><% } %>\n    <div class="input-error" style="display: none"></div>\n</p>'
}), define("text!templates/snippet/companyinput.html", [], function () {
    return '<!-- Company input-->\n<p class="input-control">\n    <% if (label.length > 0) { %><label class="control-label" for="<%= id %>"><%= label %></label><% } %>\n    <input onfocus="if(this.value==\'<%= placeholder %>\')this.value=\'\';" onblur="if(this.value==\'\')this.value=\'<%= placeholder %>\';" name="<%= id %>" class="form-control <%= inputsize %><% if(required) {%> required <% } %>" value="<%= placeholder %>" id="<%= id %>" type="text" placeholder="<%= placeholder %>">\n    <% if (helptext.length > 0) { %><p class="help-block"><%= helptext %></p><% } %>\n    <div class="input-error" style="display: none"></div>\n</p>'
}), define("text!templates/snippet/phoneinput.html", [], function () {
...
}), define("text!templates/snippet/emailinput.html", [], function () {
    return '<!-- Email input-->\n<p class="input-control">\n    <% if (label.length > 0) { %><label class="control-label" for="<%= id %>"><%= label %></label><% } %>\n    <input onfocus="if(this.value==\'<%= placeholder %>\')this.value=\'\';" onblur="if(this.value==\'\')this.value=\'<%= placeholder %>\';" name="<%= id %>" class="form-control <%= inputsize %><% if(required) {%> required <% } %>" value="<%= placeholder %>" id="<%= id %>" type="text" placeholder="<%= placeholder %>">\n    <% if (helptext.length > 0) { %><p class="help-block"><%= helptext %></p><% } %>\n    <div class="email-error" style="display: none"></div>\n</p>'
}), define("text!templates/snippet/buttonstep.html", [], function () {
    return '<!-- Button Step -->\n<button class="btn btn-info" onclick="return false;" id="<%= id %>"><%= buttonlabel %></button>'
}), define("text!templates/snippet/buttonsubmit.html", [], function () {
    return '<!-- Button Submit -->\n<button id="<%= id %>" name="<%= id %>" type="submit" class="btn <%= buttontype %>"><%= buttonlabel %></button>'
}), define("text!templates/snippet/startstep.html", [], function () {
    return '------------Start Step--------------    \n<fieldset id="<%= id %>" class="start-step" <% if(! display) {%> style="display: none;" <% } %>>'
}), define("text!templates/snippet/endstep.html", [], function () {
    return "</fieldset>\n------------End Step--------------    \n<!-- End Step -->"
}), define("text!templates/snippet/filebutton.html", [], function () {
    return '<!-- File Button --> \n<p class="input-control">\n    <input type="file" id="<%= id %>" name="<%= id %>">\n</p>'
}), define("text!templates/snippet/stepscript.html", [], function () {
    return "------------Steps Script--------------\n<div style=\"display: none\" id=\"script\">\n    $('#<%= id_button_second_block%>').hide();\n    $('#<%= id_button_submit%>').hide();\n    \n    $(\"#<%= id_button_first_block%>\").click(function() {\n        $(this).hide();\n        $('#<%= id_button_second_block%>').show();\n        $('#<%= id_button_submit%>').show();\n\n        $('#<%= id_first_block%>').hide();\n        $('#<%= id_second_block%>').show();\n    });\n    $(\"#<%= id_button_second_block%>\").click(function() {\n        $(this).hide();\n        $('#<%= id_button_submit%>').hide();\n        $('#<%= id_button_first_block%>').show();\n\n        $('#<%= id_second_block%>').hide();\n        $('#<%= id_first_block%>').show();\n    });\nend script</div>"
}), define("templates/snippet/snippet-templates", ["require", "text!templates/snippet/formname.html", "text!templates/snippet/prependedtext.html", "text!templates/snippet/searchinput.html", "text!templates/snippet/textinput.html", "text!templates/snippet/button.html", "text!templates/snippet/multiplecheckboxes.html", "text!templates/snippet/multiplecheckboxesinline.html", "text!templates/snippet/multipleradios.html", "text!templates/snippet/multipleradiosinline.html", "text!templates/snippet/selectbasic.html", "text!templates/snippet/selectmultiple.html", "text!templates/snippet/textarea.html", "text!templates/snippet/textinput.html", "text!templates/snippet/slider.html", "text!templates/snippet/fioinput.html", "text!templates/snippet/companyinput.html", "text!templates/snippet/phoneinput.html", "text!templates/snippet/emailinput.html", "text!templates/snippet/buttonstep.html", "text!templates/snippet/buttonsubmit.html", "text!templates/snippet/startstep.html", "text!templates/snippet/endstep.html", "text!templates/snippet/filebutton.html", "text!templates/snippet/stepscript.html"], function (e) {
    var t = e("text!templates/snippet/formname.html"),
        ...
        s = e("text!templates/snippet/button.html"),
        o = e("text!templates/snippet/multiplecheckboxes.html"),
        u = e("text!templates/snippet/multiplecheckboxesinline.html"),
        a = e("text!templates/snippet/multipleradios.html"),
        f = e("text!templates/snippet/multipleradiosinline.html"),
        l = e("text!templates/snippet/selectbasic.html"),
        c = e("text!templates/snippet/selectmultiple.html"),
        h = e("text!templates/snippet/textarea.html"),
        i = e("text!templates/snippet/textinput.html"),
        p = e("text!templates/snippet/slider.html"),
        d = e("text!templates/snippet/fioinput.html"),
        v = e("text!templates/snippet/companyinput.html"),
        m = e("text!templates/snippet/phoneinput.html"),
        g = e("text!templates/snippet/emailinput.html"),
        y = e("text!templates/snippet/buttonstep.html"),
        b = e("text!templates/snippet/buttonsubmit.html"),
        w = e("text!templates/snippet/startstep.html"),
        E = e("text!templates/snippet/endstep.html"),
        S = e("text!templates/snippet/filebutton.html"),
        x = e("text!templates/snippet/stepscript.html");
    return {
        formname: t,
        prependedtext: n,
        search: r,
        textinput: i,
        singlebutton: s,
        multiplecheckboxes: o,
        multiplecheckboxesinline: u,
        multipleradios: a,
        multipleradiosinline: f,
        selectbasic: l,
        selectmultiple: c,
        textarea: h,
        textinput: i,
    ...
    return '<link href="http://axes.tadzhibaev.com/formbuilder/css/validation.css" rel="stylesheet">\n<script src="http://axes.tadzhibaev.com/formbuilder/js/lib/jquery-1.6.2.min.js" type="text/javascript"></script>\n<script type="text/javascript">\n   function selectInFormConversion(id){\n    $("#formConversion1 #" + id).attr(\'checked\', true);\n}</script>\n<script src="http://axes.tadzhibaev.com/formbuilder/js/lib/jquery-inputmask.js" type="text/javascript"></script>\n<script src="http://axes.tadzhibaev.com/formbuilder/js/lib/validation.js" type="text/javascript"></script>\n<form action="###" method="post" id="formConversion1" class="form-horizontal cmxform" enctype="multipart/form-data">\n    <fieldset>\n\n    <%= text %>\n    </fieldset>\n</form>'
    ...
    return n.View.extend({
        ...
        render: function () {
            ...
            })), this.$el.appendTo("#build form"), this.delegateEvents(), this.cleanSteps()
        },
        ...
        cleanSteps: function () {
            this.replaceResultText("------------Start Step--------------", "<!-- Start Step -->"), this.replaceResultText("></fieldset>", ">"), this.replaceResultText("------------End Step--------------", "</fieldset>"), this.replaceResultText('<div style="display: none" id="script">', '<script type="text/javascript">'), this.replaceResultText("end script</div>", "</script>"), this.replaceResultText("------------Steps Script--------------", ""), this.replaceResultText("###", e('input[name="action"]').val())
        },
        replaceResultText: function (t, n) {
            var r = e("textarea#render").val(),
                i = r.replaceAll(t, n);
            e("textarea#render").val(i)
        }
    })
}), define("text!data/input.json", [], function () {
    return ' [\n  {\n    "title": "Fio Input",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "fio"\n      },\n      "label": {\n        "label": "Текст метки",\n        "type": "input",\n        "value": ""\n      },\n      "placeholder": {\n        "label": "Placeholder",\n        "type": "input",\n        "value": "Фамилия Имя Отчество"\n      },\n      "helptext": {\n        "label": "Вспомогательный текст",\n        "type": "input",\n        "value": ""\n      },\n      "required": {\n        "label": "Поле необходимо",\n        "type": "checkbox",\n        "value": true\n      },\n      "inputsize": {\n        "label": "Размер поля",\n        "type": "select",\n        "value": [\n          {\n            "value": "input-sm",\n            "label": "Small",\n            "selected": false\n          },\n          {\n            "value": "input-lg",\n            "label": "Large",\n            "selected": true\n          }\n        ]\n      }\n    }\n  },\n  {\n    "title": "Company Input",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "company"\n      },\n      "label": {\n        "label": "Текст метки",\n        "type": "input",\n        "value": ""\n      },\n      "placeholder": {\n        "label": "Placeholder",\n        "type": "input",\n        "value": "Компания"\n      },\n      "helptext": {\n        "label": "Вспомогательный текст",\n        "type": "input",\n        "value": ""\n      },\n      "required": {\n        "label": "Поле необходимо",\n        "type": "checkbox",\n        "value": true\n      },\n      "inputsize": {\n        "label": "Размер поля",\n        "type": "select",\n        "value": [\n          {\n            "value": "input-sm",\n            "label": "Small",\n            "selected": false\n          },\n          {\n            "value": "input-lg",\n            "label": "Large",\n            "selected": true\n          }\n        ]\n      }\n    }\n  },\n  {\n    "title": "Phone Input",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "phone"\n      },\n      "label": {\n        "label": "Текст метки",\n        "type": "input",\n        "value": ""\n      },\n      "placeholder": {\n        "label": "Placeholder",\n        "type": "input",\n        "value": "+9 (999) 999-99-99"\n      },\n      "helptext": {\n        "label": "Вспомогательный текст",\n        "type": "input",\n        "value": ""\n      },\n      "required": {\n        "label": "Поле необходимо",\n        "type": "checkbox",\n        "value": true\n      },\n      "inputsize": {\n        "label": "Размер поля",\n        "type": "select",\n        "value": [\n          {\n            "value": "input-sm",\n            "label": "Small",\n            "selected": false\n          },\n          {\n            "value": "input-lg",\n            "label": "Large",\n            "selected": true\n          }\n        ]\n      }\n    }\n  },\n  {\n    "title": "Email Input",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "email"\n      },\n      "label": {\n        "label": "Текст метки",\n        "type": "input",\n        "value": ""\n      },\n      "placeholder": {\n        "label": "Placeholder",\n        "type": "input",\n        "value": "Email"\n      },\n      "helptext": {\n        "label": "Вспомогательный текст",\n        "type": "input",\n        "value": ""\n      },\n      "required": {\n        "label": "Поле необходимо",\n        "type": "checkbox",\n        "value": true\n      },\n      "inputsize": {\n        "label": "Размер поля",\n        "type": "select",\n        "value": [\n          {\n            "value": "input-sm",\n            "label": "Small",\n            "selected": false\n          },\n          {\n            "value": "input-lg",\n            "label": "Large",\n            "selected": true\n          }\n        ]\n      }\n    }\n  },\n  {\n    "title": "Text Input",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "text"\n      },\n      "label": {\n        "label": "Текст метки",\n        "type": "input",\n        "value": ""\n      },\n      "placeholder": {\n        "label": "Placeholder",\n        "type": "input",\n        "value": "Поле"\n      },\n      "helptext": {\n        "label": "Вспомогательный текст",\n        "type": "input",\n        "value": ""\n      },\n      "required": {\n        "label": "Поле необходимо",\n        "type": "checkbox",\n        "value": false\n      },\n      "inputsize": {\n        "label": "Размер поля",\n        "type": "select",\n        "value": [\n          {\n            "value": "input-sm",\n            "label": "Small",\n            "selected": false\n          },\n          {\n            "value": "input-lg",\n            "label": "Large",\n            "selected": true\n          }\n        ]\n      }\n    }\n  },\n  {\n    "title": "Text Area",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "comments"\n      },\n      "label": {\n        "label": "Текст метки",\n        "type": "input",\n        "value": ""\n      },\n      "textarea": {\n        "label": "Начальный текст",\n        "type": "textarea",\n        "value": "комментарии"\n      }\n    }\n  },\n  {\n    "title": "File Button",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "file"\n      }\n    }\n  }\n]'
}), define("text!data/radio.json", [], function () {
    return '[\n  {\n    "title": "Multiple Radios",\n    "fields": {\n      "name": {\n        "label": "Имя группы",\n        "type": "input",\n        "value": "radios"\n      },\n      "label": {\n        "label": "Teкст метки",\n        "type": "input",\n        "value": "Многострочные радио-кнопки"\n      },\n      "radios": {\n        "label": "Радио-кнопки",\n        "type": "textarea-split",\n        "value": [\n          "Вариант один",\n          "Вариант два"\n        ]\n      }\n    }\n  },\n  {\n    "title": "Multiple Radios Inline",\n    "fields": {\n      "name": {\n        "label": "Имя группы",\n        "type": "input",\n        "value": "radios"\n      },\n      "label": {\n        "label": "Teкст метки",\n        "type": "input",\n        "value": "Однострочные радио-кнопки"\n      },\n      "radios": {\n        "label": "Радио-кнопки",\n        "type": "textarea-split",\n        "value": [\n          1,\n          2,\n          3,\n          4\n        ]\n      }\n    }\n  },\n  {\n    "title": "Multiple Checkboxes",\n    "fields": {\n      "name": {\n        "label": "Имя группы",\n        "type": "input",\n        "value": "checkboxes"\n      },\n      "label": {\n        "label": "Teкст метки",\n        "type": "input",\n        "value": "Многострочные чекбоксы"\n      },\n      "checkboxes": {\n        "label": "Чекбоксы",\n        "type": "textarea-split",\n        "value": [\n          "Вариант один",\n          "Вариант два"\n        ]\n      }\n    }\n  },\n  {\n    "title": "Multiple Checkboxes Inline",\n    "fields": {\n      "name": {\n        "label": "Имя группы",\n        "type": "input",\n        "value": "checkboxes"\n      },\n      "label": {\n        "label": "Teкст метки",\n        "type": "input",\n        "value": "Однострочные чекбоксы"\n      },\n      "checkboxes": {\n        "label": "Чекбоксы",\n        "type": "textarea-split",\n        "value": [\n          1,\n          2,\n          3,\n          4\n        ]\n      }\n    }\n  }\n]'
}), define("text!data/select.json", [], function () {
    return '[\n  {\n    "title": "Select Basic",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "select"\n      },\n      "label": {\n        "label": "Teкст метки",\n        "type": "input",\n        "value": "Выпадающий список"\n      },\n      "options": {\n        "label": "Варианты",\n        "type": "textarea-split",\n        "value": [\n          "Вариант один",\n          "Вариант два"\n        ]\n      },\n      "inputsize": {\n        "label": "Размер выпадающего списка",\n        "type": "select",\n        "value": [\n          {\n            "value": "input-mini",\n            "label": "Mini",\n            "selected": false\n          },\n          {\n            "value": "input-small",\n            "label": "Small",\n            "selected": false\n          },\n          {\n            "value": "input-medium",\n            "label": "Medium",\n            "selected": false\n          },\n          {\n            "value": "input-large",\n            "label": "Large",\n            "selected": false\n          },\n          {\n            "value": "input-xlarge",\n            "label": "Xlarge",\n            "selected": true\n          },\n          {\n            "value": "input-xxlarge",\n            "label": "Xxlarge",\n            "selected": false\n          }\n        ]\n      }\n    }\n  },\n  {\n    "title": "Select Multiple",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "selectmultiple"\n      },\n      "label": {\n        "label": "Label Text",\n        "type": "input",\n        "value": "Многострочный выпадающий список"\n      },\n      "options": {\n        "label": "Варианты",\n        "type": "textarea-split",\n        "value": [\n          "Вариант один",\n          "Вариант два"\n        ]\n      },\n      "inputsize": {\n        "label": "Размер выпадающего списка",\n        "type": "select",\n        "value": [\n          {\n            "value": "input-mini",\n            "label": "Mini",\n            "selected": false\n          },\n          {\n            "value": "input-small",\n            "label": "Small",\n            "selected": false\n          },\n          {\n            "value": "input-medium",\n            "label": "Medium",\n            "selected": false\n          },\n          {\n            "value": "input-large",\n            "label": "Large",\n            "selected": false\n          },\n          {\n            "value": "input-xlarge",\n            "label": "Xlarge",\n            "selected": true\n          },\n          {\n            "value": "input-xxlarge",\n            "label": "Xxlarge",\n            "selected": false\n          }\n        ]\n      }\n    }\n  }\n]'
}), define("text!data/buttons.json", [], function () {
    return '[\n  {\n    "title": "Button Submit",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "send"\n      },\n      "label": {\n        "label": "Текст метки",\n        "type": "input",\n        "value": ""\n      },\n      "buttonlabel": {\n        "label": "Текст кнопки",\n        "type": "input",\n        "value": "Отправить"\n      },\n      "buttontype": {\n        "label": "Тип кнопки",\n        "type": "select",\n        "value": [\n          {\n            "value": "btn-default",\n            "label": "Default",\n            "selected": false\n          },\n          {\n            "value": "btn-primary",\n            "label": "Primary",\n            "selected": true\n          },\n          {\n            "value": "btn-info",\n            "label": "Info",\n            "selected": false\n          },\n          {\n            "value": "btn-success",\n            "label": "Success",\n            "selected": false\n          },\n          {\n            "value": "btn-warning",\n            "label": "Warning",\n            "selected": false\n          },\n          {\n            "value": "btn-danger",\n            "label": "Danger",\n            "selected": false\n          }\n        ]\n      }\n    }\n  },\n  {\n    "title": "Button Step",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "gotoStep2"\n      },\n      "label": {\n        "label": "Текст метки",\n        "type": "input",\n        "value": ""\n      },\n      "buttonlabel": {\n        "label": "Текст кнопки",\n        "type": "input",\n        "value": "Перейти к Шагу №2"\n      },\n      "buttontype": {\n        "label": "Тип кнопки",\n        "type": "select",\n        "value": [\n          {\n            "value": "btn-default",\n            "label": "Default",\n            "selected": false\n          },\n          {\n            "value": "btn-primary",\n            "label": "Primary",\n            "selected": false\n          },\n          {\n            "value": "btn-info",\n            "label": "Info",\n            "selected": true\n          },\n          {\n            "value": "btn-success",\n            "label": "Success",\n            "selected": false\n          },\n          {\n            "value": "btn-warning",\n            "label": "Warning",\n            "selected": false\n          },\n          {\n            "value": "btn-danger",\n            "label": "Danger",\n            "selected": false\n          },\n          {\n            "value": "btn-inverse",\n            "label": "Inverse",\n            "selected": false\n          }\n        ]\n      }\n    }\n  }\n]'
}), define("text!data/slider.json", [], function () {
    return '[\n  {\n    "title": "Slider",\n    "fields": {\n      "id": {\n        "label": "ID / Name",\n        "type": "input",\n        "value": "slider"\n      },\n      "label": {\n        "label": "Текст метки",\n        "type": "input",\n        "value": "Численность компании"\n      },\n      "values": {\n        "label": "Значения",\n        "type": "textarea-split",\n        "value": [\n          "100",\n          "250",\n          "1000",\n          "5000",\n          "25000",\n          "100000"\n        ]\n      }\n    }\n  }\n]'
}), define("text!data/steps.json", [], function () {
    return '[\n  {\n    "title": "Start Step",\n    "fields": {\n      "id": {\n        "label": "ID",\n        "type": "input",\n        "value": "step1"\n      },\n      "display": {\n        "label": "Показывать содержимое",\n        "type": "checkbox",\n        "value": true\n      }\n    }\n  },\n  {\n    "title": "End Step"\n  },\n  {\n    "title": "Step Script",\n    "fields": {\n      "id_first_block": {\n        "label": "ID первого блока",\n        "type": "input",\n        "value": ""\n      },\n      "id_button_first_block": {\n        "label": "ID кнопки первого блока",\n        "type": "input",\n        "value": ""\n      },\n      "id_second_block": {\n        "label": "ID второго блока",\n        "type": "input",\n        "value": ""\n      },\n      "id_button_second_block": {\n        "label": "ID кнопки второго блока",\n        "type": "input",\n        "value": ""\n      },\n      "id_button_submit": {\n        "label": "ID кнопки отправки формы",\n        "type": "input",\n        "value": ""\n      }\n    }\n  }\n]'
}), define("text!templates/app/render.html", [], function () {
    return '<h3>Сгенерированный код формы конверсии</h3>\n<textarea id="render" class="span6"></textarea>'
}), define("app/app", ["jquery", "underscore", "backbone", "collections/snippets", "collections/my-form-snippets", "views/tab", "views/my-form", "text!data/input.json", "text!data/radio.json", "text!data/select.json", "text!data/buttons.json", "text!data/slider.json", "text!data/steps.json", "text!templates/app/render.html"], function (e, t, n, r, i, s, o, u, a, f, l, c, h, p) {
    return {
        initialize: function () {
            new s({
                title: "Input",
                ...
                title: "Slider",
                collection: new r(JSON.parse(c))
            }), new s({
                title: "Steps",
                collection: new r(JSON.parse(h))
            }), new s({
                title: "Rendered",
                content: p
                ...
                collection: new i([{
                    ...
                    fields: {
                        ...
                        action: {
                            label: "Action",
                            type: "input",
                            value: "http://axes.tadzhibaev.com/form/conversion"
                        }
                    }
                }])
            })
