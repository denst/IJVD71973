...
class Controller_Admin_Bannersrotator extends Controller_Admin {

    public $baseUrl = "admin/bannersrotator";
    public $viewPath = "admin/bannersrotator";

    public $pages = array("6", "7", "75", "76", "77", "78", "79");
    public $pageNames = array("Новости", "HR Клуб", "Видео выступлений", "Спикеры клуба", "Материалы", "Архив", "Результаты поиска");
