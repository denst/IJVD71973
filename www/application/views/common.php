   ...
   <!--noindex-->
		...
		<div class="clearfix"></div>
            ...
            <form method="post" action="" enctype="multipart/form-data" onsubmit="return check_con_form();" >
                ...
                <input type="hidden" name="snap" value="<?php echo $snap;?>">
                <?php if ($_page != "career"): ?>
                <fieldset>
                    <p>
                        <input placeholder="Имя" name="con[firstname]" class="required" id="cname" type="text" 
                            value="<?php echo(isset($post_data['con']['[firstname]'])? $post_data['con']['[firstname]']: '');?>"/>
                        <input placeholder="Фамилия" name="con[lastname]" class="required" id="clastname" type="text"
                            value="<?php echo(isset($post_data['con']['[lastname]'])? $post_data['con']['[firstname]']: '');?>"/>
                    </p>
                    <p>
                        <input placeholder="E-mail" name="con[email]" class="required email" id="cemail" type="text"
                            value="<?php echo(isset($post_data['con']['[email]'])? $post_data['con']['[firstname]']: '');?>"/>
                        <input placeholder="Телефон" name="con[phone]" class="required" id="cphone" type="text"
                            value="<?php echo(isset($post_data['con']['[email]'])? $post_data['con']['[firstname]']: '');?>"/>
                    </p>
                    <p>
                        <input placeholder="Компания" name="con[company]" class="required" id="ccompany" type="text"
                            value="<?php echo(isset($post_data['con']['[company]'])? $post_data['con']['[firstname]']: '');?>"/>
