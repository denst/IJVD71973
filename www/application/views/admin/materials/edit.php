...
<div class="page-header">
    <h2>HR Клуб: Материалы: Редактирование</h2>
</div>
<div class="row">
    <div class="span12">
        ...
        <form class="form-horizontal" method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="control-group">
                    <?php echo Form::label('path', 'Файл', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php echo Form::file('path'); ?>
                        <?php if (isset($post['path']) && preg_match('~\.(jpeg|jpg|png)~i', $post['path'])) : ?>
                            <div style="margin: 50px 0 10px 0;"><img src="<?php echo URL::base() . 'files/materials/' . $post['path']; ?>"/>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
